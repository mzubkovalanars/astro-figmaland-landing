...
const SelectTrigger = React.forwardRef<React.ElementRef, React.ComponentPropsWithoutRef>(
...
const SelectScrollUpButton = React.forwardRef<React.ElementRef, React.ComponentPropsWithoutRef>(
  ({ className, ...props }, ref) => (
...
const SelectScrollDownButton = React.forwardRef<React.ElementRef, React.ComponentPropsWithoutRef>(
  ({ className, ...props }, ref) => (
...
const SelectContent = React.forwardRef<React.ElementRef, React.ComponentPropsWithoutRef>(
...
const SelectLabel = React.forwardRef<React.ElementRef, React.ComponentPropsWithoutRef>(
  ({ className, ...props }, ref) => (
...
const SelectItem = React.forwardRef<React.ElementRef, React.ComponentPropsWithoutRef>(
  ({ className, children, ...props }, ref) => (
...
const SelectSeparator = React.forwardRef<React.ElementRef, React.ComponentPropsWithoutRef>(
  ({ className, ...props }, ref) => (
